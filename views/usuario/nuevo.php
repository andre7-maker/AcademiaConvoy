  ...
  <div class="content-wrapper">
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title">Registrar empleado</h3>
    </div>
...
<div class="content-body">
                    ...
                    <div class="card-body">
                        <form onsubmit="return validar();" class="formulario" id="formulario" action="?controller=usuarios&method=guardarDeportista" method="POST">
                          ...
                          <div class="formulario__grupo" id="grupo__nit">
                              ...
                              <div class="formulario__grupo-input">
                                <input class="formulario__input" type="text" class="form-control" id="nit" name="nit" id="inputPassword4" placeholder="1001061179">
                                <i class="formulario__validacion-estado la la-times-circle"></i>
                              </div>
                          ...
                          <div class="formulario__grupo" id="grupo__telefono">
                              ...
                              <div class="formulario__grupo-input">
                                <input class="formulario__input" type="text" class="form-control" id="telefono" name="telefono" id="inputPassword4" placeholder="1234567" >
                                <i class="formulario__validacion-estado la la-times-circle"></i>
                              </div>
                          ...
                          <!-- ///////////////////////////////////////////////////////////registro de correo//////////////////////////////////////////////////////-->
                            <div class="formulario__grupo" id="grupo__correo">
                              ...
                              <div class="formulario__grupo-input">
                                <input class="formulario__input" type="text" class="form-control" id="correo" name="correo" id="inputPassword4" placeholder="correo@gmail.com" >
                                <i class="formulario__validacion-estado la la-times-circle"></i>
                              </div>
                          ...
                          <div class="formulario__grupo" id="grupo__password">
                              ...
                              <p class="formulario__input-error">se puede recibir cualquier caracter pero no debe ser menor a 4 ni mayor a 12</p>
                          </div>
                      </div>
  ...
  <script src="views/js/validacion2.js"></script>
  <script src="views/js/validar_empleado.js"></script>
