...
<div class="content-header-right col-md-8 col-12">
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="?controller=usuarios&method=nuevoEmpleado">Agregar</a>
                  </li>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   if($usuario->Id_Estado == 1) { 
                                    ?>
                                    <a href="?controller=usuarios&method=configurarEstadoE&Id=<?php echo $usuario->Id ?>" class="btn btn-danger btn-sm">Inactivar</a>
                                    <?php
                                } elseif($usuario->Id_Estado == 2) { 
                                    ?>
                                    <a href="?controller=usuarios&method=configurarEstadoE&Id=<?php echo $usuario->Id ?>" class="btn btn-primary btn-sm">Activar</a>
                                    <?php
                                } 
                                ?> 
